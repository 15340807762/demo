...
class PreProcessor(BasePreProcessor):
    ...
    def _split_into_units(self, text: str, split_by: str) -> Tuple[List[str], str]:
        ...
        elif split_by == "word" and self.language == 'zh':
            elements = jieba.lcut(text)
            split_at = ""
        elif split_by == "word" and self.language != "zh":
            elements = text.split(" ")
            split_at = " "
    ...
    def _cut_sentences(self,content):
        # 结束符号，包含中文和英文的
        end_flag = ['?', '!', '？', '！', '。','\n','\t','\r','\v','\f','\b']
    ...
    def _split_sentences(self, text: str) -> List[str]:
        ...
        if self.language != 'zh':
            ...
            sentences = self._cut_sentences(text)
            return sentences
